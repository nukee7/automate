  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 px-3 py-2 bg-accent/10 border-b border-border">
        ...
        <span className="text-xs font-semibold text-foreground">Slack Trigger</span>
        {nodeStatus && (
